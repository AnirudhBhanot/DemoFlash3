...
def create_framework_tags_database():
    ...
    tags_db["aarrr_metrics"] = FrameworkTags(
        ...
        problem_archetypes=[ProblemArchetype.GROWTH_MECHANICS, ProblemArchetype.UNIT_ECONOMICS_OPTIMIZATION, ProblemArchetype.OPERATIONAL_EXCELLENCE],
        decision_contexts=[DecisionContext.DIAGNOSTIC, DecisionContext.EVALUATIVE],
        data_requirements=[DataRequirement.ADVANCED_METRICS, DataRequirement.HISTORICAL_DATA],
        complexity_tier=ComplexityTier.SIMPLE,
        outcome_types=[OutcomeType.OPERATIONAL_IMPROVEMENTS, OutcomeType.GROWTH_STRATEGY, OutcomeType.TACTICAL_ACTIONS],
        ...
        has_variants=True,
        keywords={"acquisition", "activation", "funnel", "metrics", "referral", "retention", "revenue"}
    )
    ...
    tags_db["ansoff_matrix"] = FrameworkTags(
        temporal_stages=[TemporalStage.TRACTION, TemporalStage.GROWTH, TemporalStage.SCALE],
        problem_archetypes=[ProblemArchetype.GROWTH_MECHANICS, ProblemArchetype.COMPETITIVE_STRATEGY, ProblemArchetype.RISK_MANAGEMENT],
        decision_contexts=[DecisionContext.PRESCRIPTIVE, DecisionContext.PREDICTIVE],
        data_requirements=[DataRequirement.MARKET_DATA, DataRequirement.BASIC_QUANTITATIVE],
        complexity_tier=ComplexityTier.SIMPLE,
        outcome_types=[OutcomeType.GROWTH_STRATEGY, OutcomeType.RISK_MITIGATION, OutcomeType.STRATEGIC_CLARITY],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"development", "diversification", "growth", "market penetration", "risk"}
    )
    ...
    tags_db["bcg_matrix"] = FrameworkTags(
        temporal_stages=[TemporalStage.VALIDATION, TemporalStage.TRACTION, TemporalStage.GROWTH, TemporalStage.SCALE, TemporalStage.MATURITY],
        problem_archetypes=[ProblemArchetype.PORTFOLIO_OPTIMIZATION, ProblemArchetype.BUSINESS_MODEL_DESIGN, ProblemArchetype.COMPETITIVE_STRATEGY],
        decision_contexts=[DecisionContext.DIAGNOSTIC, DecisionContext.PRESCRIPTIVE],
        data_requirements=[DataRequirement.MARKET_DATA, DataRequirement.BASIC_QUANTITATIVE, DataRequirement.COMPETITIVE_INTEL],
        complexity_tier=ComplexityTier.MODERATE,
        ...
        requires_software=False,
        has_variants=True,
        keywords={"growth", "investment", "portfolio", "resource allocation", "share"}
    )
    ...
    tags_db["blue_ocean_strategy"] = FrameworkTags(
        ...
        problem_archetypes=[ProblemArchetype.COMPETITIVE_STRATEGY, ProblemArchetype.INNOVATION_MANAGEMENT, ProblemArchetype.MARKET_ANALYSIS],
        decision_contexts=[DecisionContext.EXPLORATORY, DecisionContext.PRESCRIPTIVE],
        data_requirements=[DataRequirement.MARKET_DATA, DataRequirement.COMPETITIVE_INTEL, DataRequirement.QUALITATIVE_ONLY],
        complexity_tier=ComplexityTier.COMPLEX,
        outcome_types=[OutcomeType.STRATEGIC_CLARITY, OutcomeType.INNOVATION_PIPELINE, OutcomeType.COMPETITIVE_ADVANTAGE],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"competition", "differentiation", "market space", "uncontested", "value innovation"}
    )
    ...
    tags_db["customer_development"] = FrameworkTags(
        ...
        problem_archetypes=[ProblemArchetype.CUSTOMER_DISCOVERY, ProblemArchetype.PRODUCT_MARKET_FIT],
        decision_contexts=[DecisionContext.EXPLORATORY, DecisionContext.DIAGNOSTIC],
        data_requirements=[DataRequirement.QUALITATIVE_ONLY],
        complexity_tier=ComplexityTier.SIMPLE,
        outcome_types=[OutcomeType.CUSTOMER_INSIGHTS, OutcomeType.TACTICAL_ACTIONS],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"customer", "discovery", "feedback", "interviews", "validation"}
    )
    ...
    tags_db["jobs_to_be_done"] = FrameworkTags(
        temporal_stages=[TemporalStage.PRE_FORMATION, TemporalStage.FORMATION, TemporalStage.VALIDATION],
        problem_archetypes=[ProblemArchetype.CUSTOMER_DISCOVERY, ProblemArchetype.PRODUCT_MARKET_FIT, ProblemArchetype.INNOVATION_MANAGEMENT],
        decision_contexts=[DecisionContext.EXPLORATORY, DecisionContext.DIAGNOSTIC],
        data_requirements=[DataRequirement.QUALITATIVE_ONLY, DataRequirement.EXPERIMENTAL_DATA],
        complexity_tier=ComplexityTier.SIMPLE,
        outcome_types=[OutcomeType.CUSTOMER_INSIGHTS, OutcomeType.INNOVATION_PIPELINE, OutcomeType.TACTICAL_ACTIONS],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=True,
        keywords={"customer", "innovation", "needs", "outcomes", "problems", "solutions"}
    )
    ...
    tags_db["lean_canvas"] = FrameworkTags(
        temporal_stages=[TemporalStage.PRE_FORMATION, TemporalStage.FORMATION, TemporalStage.VALIDATION],
        problem_archetypes=[ProblemArchetype.BUSINESS_MODEL_DESIGN, ProblemArchetype.PRODUCT_MARKET_FIT, ProblemArchetype.CUSTOMER_DISCOVERY],
        decision_contexts=[DecisionContext.EXPLORATORY, DecisionContext.DIAGNOSTIC],
        data_requirements=[DataRequirement.QUALITATIVE_ONLY],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"business model", "mvp", "problem", "solution", "startup"}
    )
    ...
    tags_db["porters_five_forces"] = FrameworkTags(
        ...
        problem_archetypes=[ProblemArchetype.COMPETITIVE_STRATEGY, ProblemArchetype.MARKET_ANALYSIS, ProblemArchetype.BUSINESS_MODEL_DESIGN],
        decision_contexts=[DecisionContext.DIAGNOSTIC, DecisionContext.PREDICTIVE],
        data_requirements=[DataRequirement.MARKET_DATA, DataRequirement.COMPETITIVE_INTEL, DataRequirement.QUALITATIVE_ONLY],
        complexity_tier=ComplexityTier.MODERATE,
        outcome_types=[OutcomeType.STRATEGIC_CLARITY, OutcomeType.COMPETITIVE_ADVANTAGE, OutcomeType.RISK_MITIGATION],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"barriers", "buyers", "competition", "industry", "rivalry", "suppliers", "threats"}
    )
    ...
    tags_db["swot_analysis"] = FrameworkTags(
        temporal_stages=[TemporalStage.PRE_FORMATION, TemporalStage.FORMATION, TemporalStage.VALIDATION, TemporalStage.TRACTION, TemporalStage.GROWTH, TemporalStage.SCALE, TemporalStage.MATURITY],
        problem_archetypes=[ProblemArchetype.COMPETITIVE_STRATEGY, ProblemArchetype.RISK_MANAGEMENT, ProblemArchetype.BUSINESS_MODEL_DESIGN],
        decision_contexts=[DecisionContext.DIAGNOSTIC],
        data_requirements=[DataRequirement.QUALITATIVE_ONLY],
        complexity_tier=ComplexityTier.PLUG_AND_PLAY,
        outcome_types=[OutcomeType.STRATEGIC_CLARITY, OutcomeType.RISK_MITIGATION],
        industry_contexts=[IndustryContext.UNIVERSAL],
        ...
        requires_software=False,
        has_variants=False,
        keywords={"analysis", "opportunities", "strengths", "threats", "weaknesses"}
    )
    ...
    tags_db["unit_economics"] = FrameworkTags(
        ...
        problem_archetypes=[ProblemArchetype.UNIT_ECONOMICS_OPTIMIZATION, ProblemArchetype.BUSINESS_MODEL_DESIGN, ProblemArchetype.FINANCIAL_PLANNING],
        decision_contexts=[DecisionContext.DIAGNOSTIC, DecisionContext.EVALUATIVE],
        data_requirements=[DataRequirement.BASIC_QUANTITATIVE, DataRequirement.ADVANCED_METRICS],
        complexity_tier=ComplexityTier.MODERATE,
        outcome_types=[OutcomeType.FINANCIAL_PROJECTIONS, OutcomeType.TACTICAL_ACTIONS, OutcomeType.OPERATIONAL_IMPROVEMENTS],
        industry_contexts=[IndustryContext.B2B_SAAS, IndustryContext.B2C_SAAS, IndustryContext.MARKETPLACE, IndustryContext.ECOMMERCE],
        ...
        requires_software=True,
        has_variants=True,
        keywords={"cac", "economics", "ltv", "margin", "payback", "profitability"}
    )
...
def create_framework_effectiveness_database():
    ...
    effectiveness["bcg_matrix"] = FrameworkEffectiveness(
        ...
        success_factors=["Multiple product lines", "Market share data", "Growth rate data"],
        failure_factors=["Single product analysis", "Ignoring market dynamics", "Static view"],
        data_points=2500,
    ...
    effectiveness["lean_canvas"] = FrameworkEffectiveness(
        ...
        success_factors=["Basic business idea", "Target customer hypothesis"],
        failure_factors=["Over-complication", "Lack of validation", "Static document"],
        data_points=800,
        confidence_level=0.85
    )
    ...
    effectiveness["customer_development"] = FrameworkEffectiveness(
        ...
        success_factors=["Customer access", "Iterative mindset", "Pivot readiness"],
        failure_factors=["Confirmation bias", "Wrong customer segment", "Feature creep"],
        data_points=600,
        confidence_level=0.88
    )
    

    # Aarrr Metrics effectiveness
    effectiveness["aarrr_metrics"] = FrameworkEffectiveness(
        ...
        durability_months=6,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.8,
            TemporalStage.GROWTH: 0.75,
            TemporalStage.SCALE: 0.7
        },
        effectiveness_by_industry={
            IndustryContext.B2B_SAAS: 0.75,
            IndustryContext.MARKETPLACE: 0.7,
            IndustryContext.ECOMMERCE: 0.7,
    ...
    # Growth Loops effectiveness
    effectiveness["growth_loops"] = FrameworkEffectiveness(
        framework_id="growth_loops",
        success_rate=0.79,
        time_to_impact_days=14,
        effort_return_ratio=4.2,
        durability_months=12,
        ...
        effectiveness_by_industry={
            IndustryContext.B2B_SAAS: 0.75,
            IndustryContext.MARKETPLACE: 0.8,
            IndustryContext.ECOMMERCE: 0.7,
            IndustryContext.UNIVERSAL: 0.70
        },
        effectiveness_by_team_size={
    ...
    effectiveness["product_led_growth"] = FrameworkEffectiveness(
        framework_id="product_led_growth",
        success_rate=0.76,
        time_to_impact_days=30,
        effort_return_ratio=3.8,
        durability_months=18,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.7,
            TemporalStage.TRACTION: 0.8,
            TemporalStage.GROWTH: 0.85,
            TemporalStage.SCALE: 0.7
        },
        effectiveness_by_industry={
            IndustryContext.B2B_SAAS: 0.75,
            IndustryContext.MARKETPLACE: 0.8,
            IndustryContext.ECOMMERCE: 0.75,
            IndustryContext.UNIVERSAL: 0.70
        },
        effectiveness_by_team_size={
            "small": 0.75,
    ...
    # Viral Coefficient effectiveness
    effectiveness["viral_coefficient"] = FrameworkEffectiveness(
        framework_id="viral_coefficient",
        success_rate=0.71,
        time_to_impact_days=7,
        effort_return_ratio=3.5,
        durability_months=9,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
            TemporalStage.GROWTH: 0.75,
            TemporalStage.SCALE: 0.7
        },
        effectiveness_by_industry={
    ...
    # Ltv Cac Ratio effectiveness
    effectiveness["ltv_cac_ratio"] = FrameworkEffectiveness(
        framework_id="ltv_cac_ratio",
        success_rate=0.85,
        time_to_impact_days=3,
        effort_return_ratio=5.2,
        durability_months=6,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    # Burn Rate Runway effectiveness
    effectiveness["burn_rate_runway"] = FrameworkEffectiveness(
        framework_id="burn_rate_runway",
        success_rate=0.88,
        time_to_impact_days=1,
        effort_return_ratio=5.8,
        durability_months=3,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    # Saas Metrics effectiveness
    effectiveness["saas_metrics"] = FrameworkEffectiveness(
        framework_id="saas_metrics",
        success_rate=0.83,
        time_to_impact_days=7,
        effort_return_ratio=4.8,
        durability_months=6,
    ...
    # Break Even Analysis effectiveness
    effectiveness["break_even_analysis"] = FrameworkEffectiveness(
        framework_id="break_even_analysis",
        success_rate=0.8,
        time_to_impact_days=3,
        effort_return_ratio=4.5,
        durability_months=12,
    ...
    # Value Chain Analysis effectiveness
    effectiveness["value_chain_analysis"] = FrameworkEffectiveness(
        framework_id="value_chain_analysis",
        success_rate=0.75,
        time_to_impact_days=14,
        effort_return_ratio=3.5,
        durability_months=24,
    ...
    # Ansoff Matrix effectiveness
    effectiveness["ansoff_matrix"] = FrameworkEffectiveness(
    ...
    effectiveness["swot_analysis"] = FrameworkEffectiveness(
        framework_id="swot_analysis",
        success_rate=0.68,
        time_to_impact_days=3,
        effort_return_ratio=2.8,
        durability_months=12,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    # Design Thinking effectiveness
    effectiveness["design_thinking"] = FrameworkEffectiveness(
        framework_id="design_thinking",
        success_rate=0.81,
        time_to_impact_days=21,
        effort_return_ratio=3.9,
        durability_months=12,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    effectiveness["lean_startup"] = FrameworkEffectiveness(
        framework_id="lean_startup",
        success_rate=0.84,
        time_to_impact_days=30,
        effort_return_ratio=4.3,
        durability_months=9,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    # Stage Gate Process effectiveness
    effectiveness["stage_gate_process"] = FrameworkEffectiveness(
        framework_id="stage_gate_process",
        success_rate=0.72,
    ...
    effectiveness["kano_model"] = FrameworkEffectiveness(
        framework_id="kano_model",
        success_rate=0.78,
        time_to_impact_days=14,
        effort_return_ratio=3.7,
        durability_months=18,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    # Product Market Fit effectiveness
    effectiveness["product_market_fit"] = FrameworkEffectiveness(
        framework_id="product_market_fit",
        success_rate=0.86,
        time_to_impact_days=60,
        effort_return_ratio=4.6,
        durability_months=12,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.7,
            TemporalStage.TRACTION: 0.7,
    ...
    # Mvp Framework effectiveness
    effectiveness["mvp_framework"] = FrameworkEffectiveness(
        framework_id="mvp_framework",
        success_rate=0.83,
        time_to_impact_days=21,
        effort_return_ratio=4.4,
        durability_months=6,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.7,
            TemporalStage.TRACTION: 0.7,
    ...
    # Lean Methodology effectiveness
    effectiveness["lean_methodology"] = FrameworkEffectiveness(
        framework_id="lean_methodology",
        success_rate=0.79,
        time_to_impact_days=30,
        effort_return_ratio=3.8,
        durability_months=36,
    ...
    effectiveness["agile_methodology"] = FrameworkEffectiveness(
        framework_id="agile_methodology",
        success_rate=0.82,
        time_to_impact_days=14,
        effort_return_ratio=4.1,
        durability_months=24,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
    ...
    effectiveness["six_sigma"] = FrameworkEffectiveness(
        framework_id="six_sigma",
        success_rate=0.74,
        time_to_impact_days=90,
        effort_return_ratio=3.3,
        durability_months=48,
        effectiveness_by_stage={
            TemporalStage.VALIDATION: 0.6,
            TemporalStage.TRACTION: 0.7,
            TemporalStage.GROWTH: 0.75,
            TemporalStage.SCALE: 0.75
        },
        effectiveness_by_industry={
            IndustryContext.B2B_SAAS: 0.75,
            IndustryContext.MARKETPLACE: 0.7,
    ...
    # Okr Framework effectiveness
    effectiveness["okr_framework"] = FrameworkEffectiveness(
    ...
    effectiveness["balanced_scorecard"] = FrameworkEffectiveness(
    ...
    # Mckinsey 7S effectiveness
    effectiveness["mckinsey_7s"] = FrameworkEffectiveness(
        framework_id="mckinsey_7s",
        success_rate=0.76,
        time_to_impact_days=21,
        effort_return_ratio=3.5,
        durability_months=18,
